...
\\\\begin{remarque}
Ainsi, le signe négatif dans \$ ( \\omega t - \\phi ) \$ traduit simplement le fait qu’une phase plus grande implique que la vibration atteint son maximum plus tard dans le temps.end
\\\\{remarque}`,
};
