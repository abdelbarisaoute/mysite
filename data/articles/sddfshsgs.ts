...
export const sddfshsgs: Article = {
  id: 'sddfshsgs',
  title: 'sddfshsgs',
  date: '2025-11-07',
  summary: 'hfgshergdfb  etrjhezs  bdshbdsqbehethdb',
...
The coefficient \$\\underbar{U}=A e^{i\\phi}\$ is the complex amplitude of the vibration; it combines the real amplitude and the initial phase into a single complex quantity. The factor \$e^{-i\\omega t}\$ represents the harmonic time evolution. This expression also makes the phase delay \$\\phi\$ appear as a positive contribution.
...
<div id="fig:quasi-mono-examples" class="my-4">
  ...
  <p class="text-sm text-gray-600 dark:text-gray-400 mt-2 text-center italic">Figure #: (a) Truncated Monochromatic Vibration (b) Damped vibration</p>
</div>
...
<div class="flex gap-4 my-4 flex-wrap justify-center items-start">
  <div class="flex-1 min-w-[200px]" id="fig:ch2-3-expl-sinc">
    <img src="/mysite/ch2-3-expl-sinc.png" alt="ch2 3 expl sinc" class="w-full h-64 object-cover rounded-lg shadow-md" />
    <p class="text-sm text-gray-600 dark:text-gray-400 mt-2 text-center italic">Figure #</p>
  </div>
  <div class="flex-1 min-w-[200px]" id="fig:ch2-3-expl-tan">
