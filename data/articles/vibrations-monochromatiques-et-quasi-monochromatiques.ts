...
export const vibrationsMonochromatiquesEtQuasiMonochromatiques: Article = {
  ...
  content: `En physique, de nombreux phénomènes peuvent être expliqués par des oscillations ou par vibration de leur grandeur caractéristique. Le son et les ondes electromagnétiques sont modélisées par des vibrations; les premiers étant des vibrations mécaniques dans l'air et les ondes **EM** étant des vibrations simultanées d'un champ électrique et d'un champ magnétique, la lumière est également une onde électromagnétique, présentant des caractéristiques analogues à celles d'une onde mécanique, mais capable de se propager dans le vide. Contrairement au son par exemple qui ne peut se propager que dans un milieu matériel (c'est le cas pour toutes les vibrations mécaniques). 
